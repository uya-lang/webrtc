...
rg -Fq ".PHONY: all build test bench test-codec-bridge test-ffmpeg-codec-flow test-ffmpeg-codec-extern test-ffmpeg-chrome-call test-uya-vp8-chrome-call preview-ffmpeg-chrome-call preview-uya-vp8-chrome-call clean" Makefile
...
rg -Fq "test-uya-vp8-chrome-call:" Makefile
...
rg -Fq "bash tests/check_phase21_uya_vp8_chrome_call.sh" Makefile
