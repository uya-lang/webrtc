...
cache_root="/tmp/webrtc-browser-turn-interop"
...
export WEBRTC_PEER_CONFIG_JSON='{"iceServers":[{"urls":"turn:127.0.0.1:34780","username":"uya","credential":"uya-pass"}],"iceTransportPolicy":"relay"}'

python3 tests/browser_datachannel_interop.py turn

echo "Phase 17 browser TURN relay checks passed"
