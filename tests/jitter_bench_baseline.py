#!/usr/bin/env python3
"""Validate phase 12 jitter benchmark baseline rows and zero-allocation assertions."""
...
def main() -> None:
    ...
    validate_rows(rows, "bench_jitter.jsonl")

    with tempfile.NamedTemporaryFile(prefix="bench_jitter_", suffix=".jsonl", delete=False) as tmp:
