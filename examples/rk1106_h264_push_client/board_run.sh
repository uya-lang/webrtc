...
WORKDIR=${WORKDIR:-/tmp/rk1106-h264-webrtc-push}
...
echo "starting RK1106 V4L2 H264 WebRTC sender: $VIDEO_DEV ${WIDTH}x${HEIGHT} $PIXEL_FORMAT ${FPS}fps, local candidate $LOCAL_HOST" >&2
set -- \
...
"$BIN_DIR/rk1106_h264_sender" "$@" >"$SENDER_LOG" 2>&1 &
sender_pid=$!
